...
INSERT INTO `departmani` VALUES ('Departman za arhitekturu','fmarjanovic',''),('Departman za elektrotehniku','nmaric',''),('Departman za gradjevinarstvo','lsavic',''),('Departman za masinstvo','mkuzmanovic',''),('Departman za menadzment','zmarkovic',''),('Departman za saobracaj','mmitrovic','');
...
CREATE TABLE `formulari` (
  ...
  `odobrenjesef` char(1) NOT NULL,
  `odobrenjekoord` char(1) NOT NULL,
...
-- Dump completed on 2019-11-19 15:34:31
